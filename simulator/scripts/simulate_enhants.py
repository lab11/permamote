...
def simulate(config, lights):
    ...
    if secondary_config:
        ...
        secondary_capacity = secondary_config['capacity_mAh'] / 2
    ...
    print('  average primary discharge ' + str(np.mean(primary_discharges)))
    #plt.figure()
    ...
    lifetime_years = (intercept/(-slope))/(60*24*365)
    print(slope)
    print(primary_soc[-1])
