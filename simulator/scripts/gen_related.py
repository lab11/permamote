...
sec_configs = {
    ...
    'Capybara_cap_1': {
        ...
        'type' : 'capacitor',
        'esr_ohm' : 100,
        'capacity_J': (400E-6 + 330E-6 + 67.5E-3) * (3.3**2),
        'min_capacity_J': (400E-6 + 330E-6 + 67.5E-3) * (0.4**2),
    ...
    'Capybara_cap_2': {
        ...
        'min_capacity_J': (300E-6 + 1100E-6 + 7.5E-3) * (0.4**2),
        'leakage_power_W': 10E-9,
    },
    'Flicker_cap': {
        'name' : 'secondary',
        'type' : 'capacitor',
        'esr_ohm' : 0.2,
        'capacity_J': (22+2.2+47+15+33)*1E-6 * (3.3**2),
        'min_capacity_J': (22+2.2+47+15+33)*1E-6 * (0.4**2),
        'leakage_power_W': 10E-9,
    },
    'EnHANTs_battery': {
        'name' : 'secondary',
