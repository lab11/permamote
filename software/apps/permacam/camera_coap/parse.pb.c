...
/* Generated by nanopb-0.3.9.3 at Mon Apr 13 13:44:44 2020. */
...
const pb_field_t Data_fields[27] = {
    ...
    PB_FIELD( 74, INT32   , SINGULAR, STATIC  , OTHER, Data, image_exposure_time, image_ev, 0),
    PB_FIELD( 80, UINT32  , SINGULAR, STATIC  , OTHER, Data, image_id, image_exposure_time, 0),
    PB_LAST_FIELD
};
