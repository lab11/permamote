...
const pb_field_t Data_fields[26] = {
    ...
    PB_FIELD( 73, INT32   , SINGULAR, STATIC  , OTHER, Data, image_exposure, image_jpeg_quality, 0),
    PB_FIELD( 80, UINT32  , SINGULAR, STATIC  , OTHER, Data, image_id, image_exposure, 0),
    PB_LAST_FIELD
};
