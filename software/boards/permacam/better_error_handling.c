...
//
// Prints app error conditions over printf and blinks LEDs. If printf is // already set up, the print statements should appear over the normal medium
...
void __attribute__((weak)) app_error_fault_handler(uint32_t id, uint32_t pc, uint32_t info) {
